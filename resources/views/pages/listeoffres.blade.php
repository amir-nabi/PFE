                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        @else
                            <form>
                                <a class="btn btn-primary" title="Plus d'informations." style="width:35px" href="{{ route('listeoffres.show',$offre->id) }}"><i class="fa fa-info"></i></a>
                                <a class="btn btn-warning" style="width:35px;opacity:0.5;cursor:not-allowed" href="#"><i class="fa fa-pencil"></i></a>
                                <button style="width:35px;opacity:0.5;cursor:not-allowed" type="submit" class="btn btn-danger"><i class="fa fa-trash"></i></button>
                            </form>
                            @endif
                        </td>
                    </tr>
